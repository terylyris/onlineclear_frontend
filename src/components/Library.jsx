  ...
  return (
    <div className='p-4  flex justify-center items-center flex-1 flex-col max-w-[750px]'>
      ...
      <div className='w-full items-center md:my-6 md:px-3 flex flex-row  justify-around  md:justify-evenly'>
        <p>bookreturned</p>
        {
          checked ? <button onClick={checkBooks} className={'font-semibold py-2 bg-green-500 rounded-md text-white px-6'}>Check</button>:<button onClick={checkBooks} className='font-semibold py-2 bg-red-500 rounded-md text-white px-6'>Not cleared</button>
        }
      </div>
